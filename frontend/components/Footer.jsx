            ...
            <footer className="bg-gray-900 text-white py-12 px-4 font-sans tracking-wide z-10">
                <div className="text-center">
                    ...
                    <ul className="flex flex-wrap justify-center gap-x-8 gap-4 mt-8 mb-12">
                        <li>
                            <a href="https://www.facebook.com/chrispinoguna" target="_blank" rel="noopener noreferrer">
                    ...
                    <li>
                        <a href="https://www.linkedin.com/in/chrispin-oguna/" target="_blank" rel="noopener noreferrer">
                ...
                <li>
                    <a href="https://www.github.com/chrispinoguna" target="_blank" rel="noopener noreferrer">
