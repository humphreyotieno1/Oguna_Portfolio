...
export default function Footer() {
    return (
        <>
            <footer className="bg-gray-900 text-white py-12 px-4 font-sans tracking-wide z-10">
                <div className="text-center">
                    <h6 className="text-lg text-gray-300">Get in touch:</h6>

                    <ul className="flex flex-wrap justify-center gap-x-8 gap-4 mt-8 mb-12">
                        <li>
                            <a href="https://www.linkedin.com/in/chrispin-oguna-01b364233/" target="_blank" rel="noopener noreferrer">
                        ...
                        <li>
                            <a href="https://www.facebook.com/chrispin.oguna.3" target="_blank" rel="noopener noreferrer">
                        ...
                        <li>
                            <a href="https://www.instagram.com/ogunachrispin/?hl=en" target="_blank" rel="noopener noreferrer">
                        ...
                        <li>
                            <a href="https://x.com/chrisoguna" target="_blank" rel="noopener noreferrer">
                        ...
                        <li>
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" viewBox="0 0 256 256">
                                    <circle cx="128" cy="128" r="128" fill="#A6CE39" />
                                    <path fill="#fff" d="M86.3 186.2H70.9V79.1h15.4v107.1zm22.9-107.1h41.6c39.6 0 57 28.3 57 53.6 0 27.5-21.5 53.6-56.8 53.6h-41.8V79.1zm15.4 93.3h26.2c34.1 0 42.1-25.9 42.1-39.7 0-21.5-13.7-39.7-43.7-39.7h-24.7v79.4z" />
                    ...
                    {/* <div className="mb-8">
                        <a
                            ...
                            className="underline text-gray-300 hover:text-white flex items-center justify-center"
                            href="https://orcid.org/0009-0006-6057-1384"
                            target="orcid.widget"
                            rel="me noopener noreferrer"
                        >
